...
// MARK: - bsdinstruments generate

/// `bsdinstruments generate` — print a profile's rendered D source without
/// running it.
///
/// This is the "show me what bsdinstruments would actually hand to libdtrace"
...
struct GenerateCommand: ParsableCommand {
    ...
    static let configuration = CommandConfiguration(
        ...
        discussion: """
            ...
            Useful for inspecting what bsdinstruments would actually run, piping \
