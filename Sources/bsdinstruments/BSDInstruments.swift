...
/// Top-level `bsdinstruments` command. Routes to subcommands.
@main
struct BSDInstruments: ParsableCommand {

    static let configuration = CommandConfiguration(
        commandName: "bsdinstruments",
        abstract: "Apple Instruments for FreeBSD, with OpenTelemetry output.",
        discussion: """
            bsdinstruments bundles a catalog of DTrace-backed profiling templates \
