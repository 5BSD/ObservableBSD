...
final class ProfileLoaderTests: XCTestCase {
    ...
    func testRenderWithoutFilterPredicateLeavesMarkerEmpty() throws {
        ...
        XCTAssertFalse(rendered.contains("@bsdinstruments-predicate"),
    ...
    func testRenderInjectsStackActionWhenWithStack() throws {
        ...
        XCTAssertFalse(rendered.contains("@bsdinstruments-stack"),
                       "the @bsdinstruments-stack marker should be consumed")
    }
    ...
    func testRenderInjectsUstackActionWhenWithUstack() throws {
        ...
        XCTAssertFalse(rendered.contains("@bsdinstruments-ustack"),
                       "the @bsdinstruments-ustack marker should be consumed")
    }
    ...
    func testRenderLeavesStackMarkersEmptyByDefault() throws {
        ...
        XCTAssertFalse(rendered.contains("@bsdinstruments-stack"),
                       "the @bsdinstruments-stack marker should still be consumed")
        XCTAssertFalse(rendered.contains("@bsdinstruments-ustack"),
                       "the @bsdinstruments-ustack marker should still be consumed")
    }

    // MARK: - The two predicate marker flavors

    func testRenderPredicateAndMarkerWithoutFilters() throws {
        // The errno-tracer profile uses /errno != 0 @bsdinstruments-predicate-and/
        ...
        XCTAssertFalse(rendered.contains("@bsdinstruments-predicate-and"),
                       "the @bsdinstruments-predicate-and marker should be consumed")
    }
