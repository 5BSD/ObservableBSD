...
final class OTLPExporterTests: XCTestCase {
    ...
    func testEnvelopeIsValidJSON() throws {
        ...
        let record = OTLPHTTPJSONExporter.LogRecord(
            ...
            attributes: [
                (key: "bsdinstruments.profile", value: .string("kill")),
    ...
    func testEnvelopeTopLevelStructure() throws {
        ...
        XCTAssertEqual(scope["name"] as? String, "bsdinstruments")
    ...
    func testResourceAttributesMapping() throws {
        ...
        XCTAssertEqual(lookup["service.name"], "bsdinstruments")
    ...
    func testEventAttributesIncludeProfilePidExecname() throws {
        ...
        XCTAssertEqual(lookup["bsdinstruments.profile"]?["stringValue"] as? String, "kill")
        XCTAssertEqual(lookup["bsdinstruments.probe"]?["stringValue"] as? String, "syscall::kill:entry")
    ...
    func testDropCounterAppearsInEnvelope() throws {
        ...
        let record = OTLPHTTPJSONExporter.LogRecord(
            ...
            severityNumber: 9,
            body: "test",
            attributes: [(key: "bsdinstruments.profile", value: .string("kill"))]
        )
        ...
        let dropsAttr = attrs.first { ($0["key"] as? String) == "bsdinstruments.drops" }
        XCTAssertNotNil(dropsAttr, "bsdinstruments.drops attribute should be present when drops > 0")
    ...
    func testNoDropCounterWhenZeroDrops() throws {
        ...
        let dropsAttr = attrs.first { ($0["key"] as? String) == "bsdinstruments.drops" }
        XCTAssertNil(dropsAttr, "bsdinstruments.drops should be absent when drops == 0")
    }
    ...
    func testSumMetricFromCountAggregation() throws {
        ...
        XCTAssertEqual(metric["name"] as? String, "bsdinstruments.syscall-counts.counts")
    ...
    func testGaugeMetricFromMaxAggregation() throws {
        ...
        XCTAssertEqual(metric["name"] as? String, "bsdinstruments.latency.peak")
    ...
    func testMetricNameUsesProfileAndAggregationName() throws {
        ...
        let scopeMetrics = resourceMetrics[0]["scopeMetrics"] as! [[String: Any]]
        let metrics = scopeMetrics[0]["metrics"] as! [[String: Any]]
        XCTAssertEqual(metrics[0]["name"] as? String, "bsdinstruments.tcp-connect.calls")
    }
    ...
    func testMetricNameFallsBackToKindForAnonymousAgg() throws {
        ...
        let scopeMetrics = resourceMetrics[0]["scopeMetrics"] as! [[String: Any]]
        let metrics = scopeMetrics[0]["metrics"] as! [[String: Any]]
        XCTAssertEqual(metrics[0]["name"] as? String, "bsdinstruments.syscall-counts.count")
    }
